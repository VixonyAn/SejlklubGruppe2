...
namespace ClassLibrary.Services
{
    public class CourseRepository : ICourseRepository
    {
        ...
        public void Update(int id, string name, DateTime startDateTime, DateTime endDateTime, int[] attendeeRange, List<Member> attendees, Member master, string summary, string description)
        {
            _courses[id].Name = name;
            _courses[id].TimeSlot[0] = startDateTime;
            _courses[id].TimeSlot[1] = endDateTime;
            _courses[id].AttendeeRange = attendeeRange;
            _courses[id].Attendees = attendees;
            _courses[id].Master.Name = master.Name;
            _courses[id].Summary = summary;
            _courses[id].Description = description;
